      ...
      <main className="bg-white text-gray-800 overflow-hidden pt-20">
        ...
        <section className="max-w-7xl mx-auto py-20 px-6 sm:px-8 md:px-12 lg:px-20 flex flex-col lg:flex-row items-center gap-12 md:gap-16">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="relative w-full sm:w-3/4 md:w-2/3 lg:w-1/2 h-[400px] sm:h-[450px] md:h-[500px] rounded-3xl overflow-hidden shadow-xl mx-auto lg:mx-0"
          >
            <Image
              src="/profile.png"
          ...
          >
            ...
            <div className="mt-8 space-y-6 text-gray-700 leading-relaxed text-base sm:text-lg">
              ...
              <p>
                ...
                <strong>Walden University, Minneapolis (MN).</strong> He completed
                his <strong>Doctor of Nursing Practice (DNP)</strong> at{" "}
                <strong>Rush University, Chicago</strong>, and is a{" "}
                <strong>board-certified Psychiatric and Mental Health Nurse Practitioner (PMHNP-BC).</strong>
              </p>
